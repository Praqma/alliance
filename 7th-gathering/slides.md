...
</div><!-- .element class="fragment twocol " -->

<div>**Focus areas**

**Ops**<br/> _Infrastructure as Code_

**Traceability**<br/> _Compliance as Code_ <br/> _visibility_ - _tracability_ - _execution_</div><!-- .element class="fragment twocol " -->
...
![Routing](res/restaurant-map.png)
